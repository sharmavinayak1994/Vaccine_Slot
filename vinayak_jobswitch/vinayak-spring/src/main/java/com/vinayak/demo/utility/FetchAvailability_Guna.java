...
@EnableScheduling
@Component
public class FetchAvailability_Guna {



	@Scheduled(cron = "0/30 * * * * ?")
	public void connectToCowin() throws IOException, NoSuchAlgorithmException {
		System.out.println(System.currentTimeMillis()+ "STARTED GUNA!!");
		HttpGet httpGet;
		...
		try {
			...
			URI uri = new URIBuilder(httpGet.getURI()).addParameter("district_id", "348")
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				System.out.println("!!!!Connect hua GUNA!!!!!!!");
	...
	void sendmail(String places) {
	      ...
	      String recipient = "tazykhan14@gmail.com";
	      ...
	      String pass = ""; // add app password here
